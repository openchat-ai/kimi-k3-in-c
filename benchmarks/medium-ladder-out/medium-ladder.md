...
| **超低**（源盘，专家 /model） | /dev/sde |  1.8T | 100.0 MB/s | 60.2† MB/s | — | **1346.4** |
| **低**（高速盘，trunk/L2） | /dev/sdd7 |  384G | 700.0 MB/s | 693.7 MB/s | — | **192.3** |
| **—**（算力墙） | Hygon C86-3G (OPN:3350) 16C/16T | — | — | — | 93 GFLOPS fp32 峰值 | **60.1** |
